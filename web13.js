function callNewAssets(){
    ...
    .then(data => {
        ...
        if(screen.width > 600){
            ...
            // }
            if(density==2 || density ==1) multiplier = 1
            if(density< 1.8 && density >1.61) multiplier = 1.80
            if(density<1.6 && density > 1.51) multiplier = 1.53
            if(density==1.5 && density > 1.34) multiplier = 1.44
            if(density==1.33 && density > 0.67) multiplier = 1.35
