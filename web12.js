function callNewAssets(){
    ...
    .then(data => {
        ...
        if(screen.width > 600){
            ...
            // }
            if(width <1440 || (width >1440 && width <1599)) multiplier = 1.5
            if(width >1600 && width <1799) multiplier = 1.80
            if(width >1800 && width <1919) multiplier = 1.53
            if(width >1920 && width <2159) multiplier = 1.44
            if(width >2160 && width <2879) multiplier = 1.35
            if(width >2880 && width <4320) multiplier = 1.3
