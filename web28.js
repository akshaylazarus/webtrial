function callNewAssets(){
    ...
    .then(data => {
        ...
        if(screen.width > 600){
            ...
            // if(depth==30){
            //     if(density==2 || density ==1) multiplier = 1
            //     if(density == 1.8 ) multiplier = 1.80
            //     if(density == 1.6 ) multiplier = 1.53
            //     if(density== 1.5 ) multiplier = 1.44
            //     if(density== 1.33 ) multiplier = 1.35
            //     if(density== 0.66) multiplier = 1.3
            // }
            // if(depth==24){
            //     if(density==1 ) multiplier = 1
            //     if(density == 1.125 ) multiplier = 1.18
            //     if(density == 1.25 ) multiplier = 1.27
            //     if(density== 1.375 ) multiplier = 1.36
            //     if(density== 1.5625 ) multiplier = 1.59
            //     if(density== 1.875) multiplier = 1.9
            //     if(density== 2.1875) multiplier = 1.09
            //     if(density == 2.0000000596046448) multiplier = 16
            // }
            
            // console.log('Density=====>',density)
            // console.log('Time Multiplier=====>',multiplier)
