...
function callNewAssets(){
    ...
    .then(data => {
        ...
        if(screen.width > 600){
            ...
            if(height <1536){
                if(density >= 2 || density == 1) multiplier=1
                else multiplier= 2/(density+0.32)
            }else multiplier = (height - 900) / 900      
            ...
            function l32bigLoop() {         
                ...
                if (l32bigc < l32bigl.length) { 
                    ...
                    console.log("l32big===>",l32bigtimer)         
                    l32bigLoop();             
                }                      
                }, l32bigtimer)
            }
            ...
            ddata.forEach((item,i)=>{
                ...
                c6pillHead.setAttribute('class','pillhead')
                c6pillHead.innerHTML = asset[8].carddetails.pillbox.line1.attrvalue;
                let c6pillSub = document.createElement('div')
                c6pillSub.setAttribute('class','pillsub')
                c6pillSub.innerHTML = asset[8].carddetails.pillbox.line2.attrvalue;
                let c6pillSub2 = document.createElement('div')
                c6pillSub2.setAttribute('class','pillsub2')
                c6pillSub2.innerHTML = asset[8].carddetails.pillbox.line3.attrvalue;
                c6pill.appendChild(c6pillHead)
                c6pill.appendChild(c6pillSub)
                c6pill.appendChild(c6pillSub2)
                ...
                c8pillHead.setAttribute('class','pillhead')
                c8pillHead.innerHTML = asset[8].carddetails.pillbox.line1.attrvalue;
                let c8pillSub = document.createElement('div')
                c8pillSub.setAttribute('class','pillsub')
                c8pillSub.innerHTML = asset[8].carddetails.pillbox.line2.attrvalue;
                let c8pillSub2 = document.createElement('div')
                c8pillSub2.setAttribute('class','pillsub2')
                c8pillSub2.innerHTML = asset[8].carddetails.pillbox.line3.attrvalue;
                c8pill.appendChild(c8pillHead)
                c8pill.appendChild(c8pillSub)
                c8pill.appendChild(c8pillSub2)
                ...
                c9pillHead.setAttribute('class','pillhead')
                c9pillHead.innerHTML = asset[8].carddetails.pillbox.line1.attrvalue;
                let c9pillSub = document.createElement('div')
                c9pillSub.setAttribute('class','pillsub')
                c9pillSub.innerHTML = asset[8].carddetails.pillbox.line2.attrvalue;
                let c9pillSub2 = document.createElement('div')
                c9pillSub2.setAttribute('class','pillsub2')
                c9pillSub2.innerHTML = asset[8].carddetails.pillbox.line3.attrvalue;
                c9pill.appendChild(c9pillHead)
                c9pill.appendChild(c9pillSub)
                c9pill.appendChild(c9pillSub2)
                ...
                c11mpillHead.setAttribute('class','pillhead')
                c11mpillHead.innerHTML = asset[8].carddetails.pillbox.line1.attrvalue;
                let c11mpillSub = document.createElement('div')
                c11mpillSub.setAttribute('class','pillsub')
                c11mpillSub.innerHTML = asset[8].carddetails.pillbox.line2.attrvalue;
                let c11mpillSub2 = document.createElement('div')
                c11mpillSub2.setAttribute('class','pillsub2')
                c11mpillSub2.innerHTML = asset[8].carddetails.pillbox.line3.attrvalue;
                c11mpill.appendChild(c11mpillHead)
                c11mpill.appendChild(c11mpillSub)
                c11mpill.appendChild(c11mpillSub2)
