function callNewAssets(){
    fetch('https://legacy.pricingculture.com/api/admin/newwebsiteassets?uat=true',{
      method: 'GET',
      headers: {
    ...
    .then(data => {
        ...
        if(screen.width > 600){
            ...
            ddata.forEach((item,i)=>{
                ...
                let c5 = document.createElement('div')
                c5.setAttribute('class','l2smallm')
                c5.style.backgroundImage= `url(${asset[4].carddetails.cardimg})`
                c5.style.backgroundSize= 'cover'
                c5.style.backgroundPosition='center'
                c5.style.backgroundRepeat='no-repeat'
                ...
                let c6 = document.createElement('div')
                c6.setAttribute('class','l2smallm2')
                c6.style.backgroundImage= `url(${asset[5].carddetails.cardimg})`
                c6.style.backgroundSize= 'cover'
                c6.style.backgroundPosition='center'
                c6.style.backgroundRepeat='no-repeat'
                ...
                let c7 = document.createElement('div')
                c7.setAttribute('class','l2smallm3')
                c7.style.backgroundImage= `url(${asset[6].carddetails.cardimg})`
                c7.style.backgroundSize= 'cover'
                c7.style.backgroundPosition='center'
                c7.style.backgroundRepeat='no-repeat'
                ...
                let c8 = document.createElement('div')
                c8.setAttribute('class','l2smallm4')
                c8.style.backgroundImage= `url(${asset[7].carddetails.cardimg})`
                c8.style.backgroundSize= 'cover'
                c8.style.backgroundPosition='center'
                c8.style.backgroundRepeat='no-repeat'
                ...
                let c9 = document.createElement('div')
                c9.setAttribute('class','l3smallm')
                c9.style.backgroundImage= `url(${asset[8].carddetails.cardimg})`
                c9.style.backgroundSize= 'cover'
                c9.style.backgroundPosition='center'
                c9.style.backgroundRepeat='no-repeat'
                ...
                let c10 = document.createElement('div')
                c10.setAttribute('class','l3smallm2')
                c10.style.backgroundImage= `url(${asset[9].carddetails.cardimg})`
                c10.style.backgroundSize= 'cover'
                c10.style.backgroundPosition='center'
                c10.style.backgroundRepeat='no-repeat'
                ...
                let c11 = document.createElement('div')
                c11.setAttribute('class','l3smallm3')
                c11.style.backgroundImage= `url(${asset[10].carddetails.cardimg})`
                c11.style.backgroundSize= 'cover'
                c11.style.backgroundPosition='center'
                c11.style.backgroundRepeat='no-repeat'
                ...
                let c12 = document.createElement('div')
                c12.setAttribute('class','l3smallm4')
                c12.style.backgroundImage= `url(${asset[11].carddetails.cardimg})`
                c12.style.backgroundSize= 'cover'
                c12.style.backgroundPosition='center'
                c12.style.backgroundRepeat='no-repeat'
            ...
            // var l1m3 = document.querySelectorAll('.l1smallm3')
            // console.log('L1M3====>',l1m3.length)
            // var l1m3c = 1;   
            // var l1m3timer = 3140;               
            // function l1m3Loop() {         
            //     setTimeout(function() {   
            ...
            // var l2m1 = document.querySelectorAll('.l2smallm')
            // console.log('L2M1====>',l2m1.length)
            // var l2mc = 1;  
            // var l2mtimer=30                
            // function l2mLoop() {         
            //     setTimeout(function() {   
            //     l2m1[l2mc].classList.add('fade-out') 
            //     l2mc++;                    
            //     if (l2mc < l2m1.length) {  
            //         l2mtimer = 7000           
            //         l2mLoop();             
            ...
            // var l2m2 = document.querySelectorAll('.l2smallm2')
            // console.log('L2M2====>',l2m2.length)
            // var l2m2c = 1;  
            // var l2m2timer=1230                
            // function l2m2Loop() {         
            //     setTimeout(function() {   
            //     l2m2[l2m2c].classList.add('fade-out') 
            //     l2m2c++;                    
            //     if (l2m2c < l2m2.length) {  
            //         l2m2timer = 7000       
            //         l2m2Loop();             
            //     }                      
            //     }, l2m2timer)
            ...
            // var l2m3 = document.querySelectorAll('.l2smallm3')
            // console.log('L2M3====>',l2m3.length)
            // var l2m3c = 1;   
            // var l2m3timer = 3140;               
            // function l2m3Loop() {         
            //     setTimeout(function() {   
            //     l2m3[l2m3c].classList.add('fade-out') 
            //     l2m3c++;                    
            //     if (l2m3c < l2m3.length) { 
            //         l2m3timer =  7000         
            //         l2m3Loop();             
            //     }                      
            //     }, l2m3timer)
            ...
            // var l2m4 = document.querySelectorAll('.l2smallm4')
            // var l2m4c = 1;   
            // var l2m4timer = 5000;               
            // function l2m4Loop() {         
            //     setTimeout(function() {   
            //     l2m4[l2m4c].classList.add('fade-out') 
            //     l2m4c++;                    
            //     if (l2m4c < l2m4.length) { 
            //         l2m4timer =  7000          
            //         l2m4Loop();             
            //     }                      
            //     }, l2m4timer)
            ...
            // var l3m1 = document.querySelectorAll('.l3smallm')
            // console.log('L3M1====>',l3m1.length)
            // var l3mc = 1;  
            // var l3mtimer=30                
            // function l3mLoop() {      
            //     setTimeout(function() {   
            //     l3m1[l3mc].classList.add('fade-out') 
            //     l3mc++;                    
            //     if (l3mc < l3m1.length) {  
            //         l3mtimer = 7000           
            //         l3mLoop();             
            ...
            // var l3m2 = document.querySelectorAll('.l3smallm2')
            // console.log('L3M2====>',l3m2.length)
            // var l3m2c = 1;  
            // var l3m2timer=1230                
            // function l3m2Loop() {    

            //     setTimeout(function() {   
            //     l3m2[l3m2c].classList.add('fade-out') 
            //     l3m2c++;                    
            //     if (l3m2c < l3m2.length) {  
            //         l3m2timer = 7000       
            //         l3m2Loop();             
            //     }                      
            //     }, l3m2timer)
            ...
            // var l3m3 = document.querySelectorAll('.l3smallm3')
            // console.log('L3M3====>',l3m3.length)
            // var l3m3c = 1;   
            // var l3m3timer = 3140;               
            // function l3m3Loop() {         
            //     setTimeout(function() {   
            //     l3m3[l3m3c].classList.add('fade-out') 
            //     l3m3c++;                    
            //     if (l3m3c < l3m3.length) { 
            //         l3m3timer =  7000         
            //         l3m3Loop();             
            //     }                      
            //     }, l3m3timer)
            ...
            // var l3m4 = document.querySelectorAll('.l3smallm4')
            // var l3m4c = 1;   
            // var l3m4timer = 5000;               
            // function l3m4Loop() {         
            //     setTimeout(function() {   
            //     l3m4[l3m4c].classList.add('fade-out') 
            //     l3m4c++;                    
            //     if (l3m4c < l3m4.length) { 
            //         l3m4timer =  7000          
            //         l3m4Loop();             
            //     }                      
            //     }, l3m4timer)
